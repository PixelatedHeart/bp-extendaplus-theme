...
<?php 
		global $bp; 
		$tipo_usuario = strip_tags(xprofile_get_field_data('Tipo', $bp->displayed_user->id));		
?>
	...
	<div id="content">
		...
		<form action="" method="post" id="groups-directory-form" class="dir-form">
			<h3><?php _e( 'Groups Directory', 'buddypress' ); echo 'tipo:'.$tipo_usuario; ?>
				<?php if ( is_user_logged_in() && ($tipo_usuario != 'Oficinas')) : ?> 
					&nbsp;a<a class="button" href="<?php echo bp_get_root_domain() . '/' . BP_GROUPS_SLUG . '/create/' ?>"><?php _e( 'Create a Group', 'buddypress' ) ?></a>
				<?php endif; ?>
			</h3>
