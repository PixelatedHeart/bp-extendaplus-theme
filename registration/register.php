	...
	<div id="content">
		...
		<div class="page" id="register-page">
			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<h2><?php _e( 'Create an Account', 'buddypress' ) ?><a href="<?php site_url(); ?>/tutoriales/tutorial-de-registro/" target="_blank"><img class="imagen-ayuda" src="<?php site_url(); ?>/wp-content/uploads/2011/08/tutorial.png" alt="Ir al tutorial" /></a></h2>

				<?php do_action( 'template_notices' ) ?>

				<p><?php _e( 'Registrarse en la Red Extenda Plus es fácil, basta con rellenar el formulario que aparece a continuación, no perderás nada de tiempo.', 'buddypress' ) ?></p>
				...
				<?php if ( bp_is_active( 'xprofile' ) ) : ?>
					...
					<div class="tipo-cuenta">
						...
						<h4><?php 
								//Los tipos que hemos quitado son: Catédras, Empleados, Oficinas y Becas
								_e( 'Tipo de cuenta', 'buddypress' );
						?></h4>
						...
						<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
							...
							<?php if ( 'radio' == bp_get_the_profile_field_type() ) : ?>
								<div class="editfield">
									...
									<div class="desc-tipo-usu">
										<div class="description" style="width:48%;float:left;"><span class="tipo-usu">Empresa</span><br />Elige este tipo de usuario si formas parte de una empresa que opera en el mercado internacional. Recibirás un mail de activación de tu cuenta y un link para unirte al grupo de tu empresa o crearlo en el caso de que no exista.
										</div>
										<div class="description" style="width:48%;float:right;"><span class="tipo-usu">Profesional</span><br />Elige este tipo de usuario si eres un profesional independiente y trabajas en comercio exterior. Completa el campo nombre de empresa con tu nombre personal o comercial si lo tienes.
										</div>
									</div>
				...
				<div class="register-section" id="basic-details-section">
					...
					<label for="signup_username"><?php _e( 'Username', 'buddypress' ) ?> <?php _e( '(Requerido)', 'buddypress' ) ?></span></label>
					<p style="color:red;margin-bottom:1px;">Sólo minúsculas y números sin espacios</p>
				...
				<?php if ( bp_is_active( 'xprofile' ) ) : ?>
					...
					<div class="register-section" id="profile-details-section">
						...
						<?php do_action( 'extenda_after_signup_profile_fields' ) ?>
